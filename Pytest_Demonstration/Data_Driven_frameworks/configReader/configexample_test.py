...
def test_validLogin():
        ...
        driver.get(configreader.getDatas("info","url"))
        driver.maximize_window()
        wait = WebDriverWait(driver,30)
        account = driver.find_element(By.XPATH,"//div[@id='top-links']/ul/li[2]/a")
        account.click()
        ...
        username.send_keys(configreader.getDatas("credentials","username"))

        password = driver.find_element(By.XPATH,"//*[@id='input-password']")
        password.send_keys(configreader.getDatas("credentials","password"))
